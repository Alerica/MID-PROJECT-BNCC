...
<main id="main" class="flexbox-col view-width">
    ...
    <!-- Log Out button -->
    <div class = "button_slide slide_down" onclick="openLogoutPopup()">Log Out</div>
    <!-- Logout popup -->
    <div id="logoutPopup" class="search-popup">
      <button onclick="closeLogoutPopup()" aria-label="close" class="x">❌</button>
      <div class="content">
